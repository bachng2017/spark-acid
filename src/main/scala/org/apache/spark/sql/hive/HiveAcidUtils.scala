...
import org.apache.spark.sql.catalyst.expressions.{Attribute, AttributeReference, BoundReference, Expression, InterpretedPredicate, Predicate, PrettyAttribute}
...
object HiveAcidUtils {
  ...
  def prunePartitionsByFilter(
    ...
    if (predicates.isEmpty) {
      ...
      val boundPredicate =
        Predicate.create(predicates.get.transform {
          case att: Attribute =>
